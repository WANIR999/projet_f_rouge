				...
				<div class="card-body bg-light">
					...
					<form method="post">
                        ...
                        <input type="hidden" name="id" value="<?php echo $payment->id;?>">
							...
							<input type="text" name="name" value="<?php echo $payment->product;?>" class="form-control" placeholder="Name">
						</div>
						<div class="form-group">
							<label for="prenom">price</label>
							<input type="text" name="price" value="<?php echo $payment->price;?>" class="form-control" placeholder="price">
						</div>
						<div class="form-group">
							<label for="prenom">date*</label>
							<input type="date" name="date" value="<?php echo $payment->date;?>" class="form-control" placeholder="date">
						</div>
						<div class="form-group">
