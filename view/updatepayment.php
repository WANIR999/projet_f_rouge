				...
				<div class="card-body bg-light">
					...
					<form method="post" class="needs-validation" novalidate>
                        ...
                        <input type="hidden" name="id" value="<?php echo $payment->id;?>">
							...
							<input type="text" name="name" pattern="^([^a-zA-Z]*[A-Za-z]){4}[\s\S]*" value="<?php echo $payment->product;?>" class="form-control" placeholder="Name" required>
						...
						<div class="form-group">
							...
							<input type="text" name="price" pattern="[0-9]*{4}" value="<?php echo $payment->price;?>" class="form-control" placeholder="price" required>
							<div class="invalid-feedback">
							not valid
							</div>
						</div>
